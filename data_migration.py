...
base_url = "http://localhost:8000/api_fhir_r4/"
page_offset = "&page-offset="
page_count = "?_count=50"
user = "spiderman"
password = "spiderman"
EOF = -1
...
def read_json(resource_name):

    page = 1
    url = base_url + resource_name + "/" + page_count
    ...
    while req.status_code != 404:
        ...
        if resources_next_page is not None:
            print("Got " + resource_name + " resource page " + str(page) + "\n")
            # for i in range(len(resources_next_page)):
                # if input == "Claim":
                #     data.append(resources_next_page[i])
                # else:
            data['entry'] += resources_next_page
...
class Database:
    ...
    def create_practitioner_role_table(self):
    ...
    def create_practitioner_table(self):
    ...
    def create_claim_item_table(self):
    ...
    def create_claim_diagnosis_table(self):
    ...
    def create_claim_insurance_table(self):
    ...
    def create_claim_response_table(self):
    ...
    def create_claim_response_total_table(self):
    ...
    def create_claim_response_item_table(self):
    ...
    def create_claim_response_item_adjudication_table(self):
    ...
    def create_communication_request_table(self):
        ...
        for i in range(len(bundle.entry)):
            ...
            if medication.extension is not None:
                ...
                if gender := [x for x in medication.extension if x.url == "useContextGender"]:
                    if man := [x for x in gender[0].valueUsageContext.valueCodeableConcept.coding if
                               x.display == "Male"]:
                        male = man[0].code
                    if woman := [x for x in gender[0].valueUsageContext.valueCodeableConcept.coding if
                                 x.display == "Female"]:
                        female = woman[0].code
                if age := [x for x in medication.extension if x.url == "useContextAge"]:
                    if adul := [x for x in age[0].valueUsageContext.valueCodeableConcept.coding if
                                x.display == "Adult"]:
                        adult = adul[0].code
    ...
    def create_activity_definition_table(self):
    ...
    def create_healthcare_service_table(self):
    ...
    def create_healthcare_service_coverage_area_table(self):
    ...
    def create_tables(self):
        ...
        self.create_practitioner_role_table()
        self.create_practitioner_table()
        self.create_claim_table()
        self.create_claim_item_table()
        self.create_claim_diagnosis_table()
        self.create_claim_insurance_table()
        self.create_claim_response_table()
        self.create_claim_response_total_table()
        self.create_claim_response_item_table()
        self.create_claim_response_item_adjudication_table()
        self.create_communication_request_table()
        self.create_medication_table()
        self.create_activity_definition_table()
